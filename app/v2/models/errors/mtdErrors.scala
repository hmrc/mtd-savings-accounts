...
object RuleTaxYearRangeNotSupportedError extends Error("RULE_TAX_YEAR_RANGE_NOT_SUPPORTED", "Tax year range not supported. A tax year range of one year is required")
