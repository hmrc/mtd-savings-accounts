...
trait MockSavingsAccountAnnualSummaryService extends MockFactory {

  val mockSavingsAccountAnnualSummaryService: SavingsAccountAnnualSummaryService = mock[SavingsAccountAnnualSummaryService]
