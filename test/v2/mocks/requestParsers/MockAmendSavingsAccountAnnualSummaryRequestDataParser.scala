...
import v2.models.requestData.{AmendSavingsAccountAnnualSummaryRawData, AmendSavingsAccountAnnualSummaryRequest}

trait MockAmendSavingsAccountAnnualSummaryRequestDataParser extends MockFactory {

  val mockAmendSavingsAccountAnnualSummaryRequestDataParser = mock[AmendSavingsAccountAnnualSummaryRequestDataParser]
