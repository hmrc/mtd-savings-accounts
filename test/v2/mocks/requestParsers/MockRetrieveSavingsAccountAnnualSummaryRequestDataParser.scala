...
import v2.controllers.requestParsers.RetrieveSavingsAccountAnnualSummaryRequestDataParser
...
trait MockRetrieveSavingsAccountAnnualSummaryRequestDataParser extends MockFactory {

  val mockRetrieveSavingsAnnualSummaryRequestDataParser = mock[RetrieveSavingsAccountAnnualSummaryRequestDataParser]
